...
<script>window.BOARD={id:<?=$list['id']?>,canWrite:true,founder:true,archived:true,visibility:<?=json_encode($list['visibility'])?>,tags:<?=json_encode(array_map(fn($t)=>['id'=>(int)$t['id'],'name'=>$t['name']],$tags),JSON_UNESCAPED_UNICODE)?>};</script>
